...
export default function ProfileHeader({user, currentProfile, fullName, currentRole}) {
    ...
    console.log("PROPS", user, currentProfile, fullName, currentRole)

    const toTitleCase = str => str.replace(/\b\w/g, c => c.toUpperCase());

    console.log("titlecase", toTitleCase(currentRole));
                ...
                <div className='profile-header-left'>
                    ...
                    <div className='profile-info'>
                        ...
                        <div className='profile-badges'>
                            <span className='badge badge-author'>Default Login Role: {user.default_login_role}</span>
                            <span className='badge badge-author'>Current Role: {currentRole}</span>
